...
public class HttpBatchSourceETLTest extends HttpSourceETLTest {
  @ClassRule
  ...
  public List<StructuredRecord> getPipelineResults(Map<String, String> sourceProperties,
    ...
    Map<String, String> allProperties = getProperties(sourceProperties);
    ...
    ApplicationId pipelineId = NamespaceId.DEFAULT.app("HttpBatch_" + testName.getMethodName());
